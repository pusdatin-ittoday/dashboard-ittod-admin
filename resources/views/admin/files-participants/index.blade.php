...
>
    <div class="space-y-6">
        <div class="flex justify-end">
            <a href="{{ route('admin.files.index') }}" class="inline-flex items-center justify-center rounded-md border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50">

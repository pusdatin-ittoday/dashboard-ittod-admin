...
class GoogleSheetService
{
    ...
    public function exportRecap(string $type, ?string $eventId = null): string
    {
        ...
        return $this->exportFromCallback($sheetTitle, $writeCallback);
    }

    /**
     * Export rows generated by a callback to a tab in the master Google Spreadsheet.
     *
     * @param string   $sheetTitle
     * @param callable $writeCallback function($handle): void
     * @return string URL of the Google Spreadsheet
     */
    public function exportFromCallback(string $sheetTitle, callable $writeCallback): string
    {
